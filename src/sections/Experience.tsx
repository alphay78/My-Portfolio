...
export const Experience = () => {
  const stack = [
    { name: "Next.js", logo: <IconBrandNextjs size={90} stroke={1.25} /> },
    { name: "React", logo: <IconBrandReact size={90} stroke={1.25} /> },
    { name: "Redux Toolkit", logo: <IconBrandRedux size={90} stroke={1.25} /> },
    {
      name: "Tailwind CSS",
      logo: <IconBrandTailwind size={90} stroke={1.25} />,
    },
    {
      name: "Framer Motion",
      logo: <IconBrandFramerMotion size={90} stroke={1.25} />,
    },

    { name: "Node.js", logo: <IconBrandNodejs size={90} stroke={1.25} /> },
    { name: "MongoDB", logo: <IconBrandMongodb size={90} stroke={1.25} /> },
    { name: "Prisma ORM", logo: <IconBrandPrisma size={90} stroke={1.25} /> },
    { name: "SQL", logo: <IconSql size={90} stroke={1.25} /> },
    { name: "Express.js", logo: <IconGrain size={90} stroke={1.25} /> },

    {
      name: "TypeScript",
      logo: <IconBrandTypescript size={90} stroke={1.25} />,
    },
    {
      name: "JavaScript",
      logo: <IconBrandJavascript size={90} stroke={1.25} />,
    },
    { name: "Go (Golang)", logo: <IconBrandGolang size={90} stroke={1.25} /> },
    {
      name: "Git & Collaboration",
      logo: <IconGitPullRequest size={90} stroke={1.25} />,
    },
  ];
