...
const footerLinks = [
  {
    title: "Github",
    href: "https://github.com/alphay78?tab=overview&from=2025-12-01&to=2025-12-19",
  },
  {
    title: "Telegram",
    href: "https://t.me/HolisticDeveloper",
  },
  {
    title: "Phone",
    href: "tel:+25184746454",
  },
  {
    title: "Email",
    href: "lond2601@gmail.com",
  },
  {
    title: "Linkedin",
    href: "https://www.linkedin.com/in/alpha-israel-023197294/",
  },
  // {
  //   title: "Twitter",
      ...
      <div className="container">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col md:flex-row md:justify-between items-center gap-8">
          <div className="text-white/40">
            &copy; {new Date().getFullYear()} Alpha Degago. All rights
            reserved.
          </div>
